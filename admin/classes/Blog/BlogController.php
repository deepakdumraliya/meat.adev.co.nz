<?php
	...
	class BlogController extends PageController
	{
		...
		protected static function getControllerFromPattern(UrlController $parent = null, array $matches = [], $pattern = "")
		{
			...
			if($article->isNull() || !$parent instanceof PageController)
			{
				return null;
			}

			return new self($parent->page, $article);
		}
		 ...
		 */
		 protected function getTemplateVariables()
 		{
 			...
 			if($this->article !== null)
 			{
				...
				$variables['banners'] = $this->article->getVisibleBanners();
 			}
 			else
 			{
 				$currentPage = isset($_GET['page']) ? $_GET['page'] : 1;
 				$variables["currentPage"] = $currentPage;
				$variables["articles"] = BlogArticle::loadPagesForMultiple(['active' => true], ['date' => false, 'id' => false], $currentPage, BlogArticle::PER_PAGE);
 			}
